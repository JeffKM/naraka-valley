...
for t in ("weeds", "ember", "stump"):
    for v in (1, 2, 3):
        raw = Image.open(f"{ST}/v4_{t}_{v}.png")
...
dr.text((padx, 12), "DEBRIS v4 (ref-palette) on grass  x7  weeds=scythe ember=pickaxe log=axe", fill=(220,210,200,255))
...
sheet.save(f"{ST}/_CONTACT_SHEET_v4.png"); print("done", sheet.size)
