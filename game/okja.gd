...
const LINES_INTRO := [
	"…깨어났군. 여기는 나라카, 죽은 자들의 카페다. 난 옥자, 이곳의 주인이지.",
	"길게 안 한다. 넌 이제 이 카페 소속이야. 계약은 종신 — 나갈 길은 없어.",
	"죄값은 일로 치른다. 우선 밭부터. 흙 갈고, 씨 뿌리고, 물 주고, 거두면 돼.",
	"…그 얼굴로 날 멀뚱히 보는군. 넌 날 기억 못 하나 보지. 됐다, 언젠가 알게 돼.",
