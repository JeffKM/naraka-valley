...
const CATALOG := {
	...
	SAMDOCHEON: {
		...
		"warps": [
			...
			{"to": HWANGCHEONHAE, "at": Vector2i(54, 20), "dest": Vector2i(2, 16)},  # 동단 하구 → 황천해(dest=황천해 안, 불변)
		],
	},
	...
	HWANGCHEONHAE: {
		...
		"warps": [
			{"to": SAMDOCHEON, "at": Vector2i(1, 16), "dest": Vector2i(53, 20)},  # 서단 → 삼도천 하구(★C4: 하구 at 54,20 한 칸 안)
		],
	},
