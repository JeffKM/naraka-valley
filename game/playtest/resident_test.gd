...
func _run_checks() -> void:
	...
	_check("③a 주민 18인 등록(★T8 모찌 · ★S3-T5 뱃사공 · ★S4-T7 옹이 · ★S5-T3 풀무 · ★S5-T6 무골 · ★S9b-T1 깨비·켄 · ★S9b-T2 설화·스칼렛 · ★S9b-T3 미르·루카 · ★S9b-T4 프로스티 · ★S6-T7 주방요괴 추가)",
		m._residents.size() == 18)
	_check("③b 18인 = 미호·멜·바나·네오·옥자·모찌·뱃사공·옹이·풀무·무골·깨비·켄·설화·스칼렛·미르·루카·프로스티·주방요괴",
		ids == ["miho", "mel", "bana", "neo", "okja", "mochi", "boatman", "ongi", "pulmu",
			"mugol", "kkaebi", "ken", "seolhwa", "scarlet", "mir", "luca", "frosty",
			"kitchen_youkai"])
	...
	#   잡아낸 전례가 있다).
	_check("⑧a 관계 트랙 보유 16인 전원(옥자·주방요괴만 제외)",
		names == ["미호", "멜", "바나", "네오", "모찌", "뱃사공", "옹이", "풀무", "무골",
			"깨비", "켄", "설화", "스칼렛", "미르", "루카", "프로스티"])
