...
- [ ] **멜** — 카페 경제·회계 (도박/사채 → 역전) → [§2.3](./docs/design/game-loops.md)
- [ ] **바나** — 밤 경비·손님 응대 (주거침입/흡혈 → 역전) → [§2.4](./docs/design/game-loops.md)
- [ ] 카페 운영(가공·서빙) 본격화 — 키운 작물 → 메뉴(루프 합류점) → [§2.7](./docs/design/game-loops.md)
- [ ] 채광(업화 갱도), 전투(탈주 잡귀), 커스터마이징(팔레트+프리셋, 커스터마이징 C→A) → [§2.5–2.6](./docs/design/game-loops.md)
- [ ] 계절·달력 확장, 농사 2·3층 재방문(재생장·품질·숙련) → [§2.1, §2.8](./docs/design/game-loops.md)
