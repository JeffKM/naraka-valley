...
### Sprint 5 (~2주) — 멜: 카페 경제·회계 루프 1층 MVP
- [ ] 멜 NPC 배치 + 대화·호감도 (T3.2/T3.3 틀·[miho-heart-arc](./docs/design/miho-heart-arc.md) 재사용) · 의존: T4.3
- [ ] 카페 경제 1층 MVP — 출하대(`_process_shop`)를 멜 운영 형태로 + 일일 정산 → [§2.3](./docs/design/game-loops.md)
- [ ] 멜 관계 보상축 (여우불 대응 — 판매가/이자/장부 보너스, *내용은 grill로*) · 메모: 멜=옥자 '사실' 조각(ADR-0005)
- **▶ 플레이 산출물:** 멜과 친해지며 카페 경제가 굴러간다.
...
- [ ] 계절·달력 확장 + **농사·멜·바나 2·3층 심화**(재생장·품질·숙련 / 시세·이자·장부 / 손님 다양성) → [§2.1, §2.3–2.4, §2.8](./docs/design/game-loops.md)
