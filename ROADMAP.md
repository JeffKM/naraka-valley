...
- [ ] 밤 경비 1층 MVP — `clock.phase()` '밤'에 탈주 잡귀/불청객 막기 + 손님 응대 → [§2.4](./docs/design/game-loops.md)
- [ ] 바나 관계 보상축 (밤 안전/손님 흐름 보너스, *내용은 grill로*) · 메모: 바나=옥자 '목격' 조각(ADR-0005)
- **▶ 플레이 산출물:** 밤이 농사와 다른 활동으로 채워진다.
